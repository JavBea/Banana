...
def get_from_json(data_type="CR"):
    global colors
    global bounds
    global new_min
    global new_max
...
def visualize_radar_data(file_path,
    ...
    if known_length is not None:
        final_data = final_data[:known_length]
    # # plot_histogram(final_data)
...
file_path = r"C:\Users\Me\Desktop\雷达数据\20250228\CR\D20250228090622.CRF"

get_from_json()

# CR最佳长宽：（340，300） 编码方式：uint16, 设置只取前300行
visualize_radar_data(file_path,row_len=300,encoding='uint16',certain_width=True,known_length=300)
# 前340行全取
